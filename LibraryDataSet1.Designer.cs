...
namespace Программа_библиотека {
    ...
    public partial class LibraryDataSet1 : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public BooksRow AddBooksRow(string Name_Book, string On_hands) {
...
namespace Программа_библиотека.LibraryDataSet1TableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([ID_Book] = @Original_ID_Book) AND ([Name_Book]" +
                " = @Original_Name_Book) AND ((@IsNull_On_hands = 1 AND [On_hands] IS NULL) OR ([" +
                "On_hands] = @Original_On_hands)))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [Name_Book] = @Name_Book, [On_hands] = @On_hands WHERE (([ID_Book] = @Original_ID_Book) AND ([Name_Book] = @Original_Name_Book) AND ((@IsNull_On_hands = 1 AND [On_hands] IS NULL) OR ([On_hands] = @Original_On_hands)));
SELECT ID_Book, Name_Book, On_hands FROM Books WHERE (ID_Book = @ID_Book)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_Book, Name_Book, On_hands FROM dbo.Books";
        ...
        public virtual int Delete(int Original_ID_Book, string Original_Name_Book, string Original_On_hands) {
            ...
            if ((Original_On_hands == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_On_hands));
            }
        ...
        public virtual int Update(string Name_Book, string On_hands, int Original_ID_Book, string Original_Name_Book, string Original_On_hands, int ID_Book) {
            if ((Name_Book == null)) {
            ...
            if ((On_hands == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[1].Value = ((string)(On_hands));
            }
            ...
            if ((Original_On_hands == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(Original_On_hands));
            }
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(ID_Book));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name_Book, string On_hands, int Original_ID_Book, string Original_Name_Book, string Original_On_hands) {
            return this.Update(Name_Book, On_hands, Original_ID_Book, Original_Name_Book, Original_On_hands, Original_ID_Book);
        }
    }
